...
当前提供命令：`list_connections`、`list_volumes`、`create_local_storage`、`list_entries`、`stat_entry`、`create_directory`、`rename_entry`、`delete_entry`。
...
| 任务书能力 | 本轮状态 | 下一步 |
| --- | --- | --- |
| 本地已有目录与持久化 | 已实现 | 增加移除连接、编辑名称/只读配置 |
